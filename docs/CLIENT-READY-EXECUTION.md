...
| D / P4 | Bounded pagination and server-side search/filter/sort, quotas, complete export, conflict UX and measured load | [D1](TASK-PAGINATION.md): 2,106 rows; [D2a](TASK-VERSIONS.md): conditional writes; [D2b](TASK-SEARCH.md): finder; [D2c](TASK-QUOTAS.md): transactional quotas, usage UI, four-client mixed fixture; 303 regression + 9 operator-helper checks | D1/D2a/D2b/D2c complete; main-view memory bounding, physical/global storage control and broader capacity profiling remain |
