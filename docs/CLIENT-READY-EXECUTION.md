...
| E / P6-P7 | Member directory/assignment picker, workspace rename/archive/owner transfer, private saved views, scoped comments and mentions | [P6a](TEAM-COLLABORATION.md): directory/assignment/rename; [P6b](WORKSPACE-OWNERSHIP.md): ownership; [P6c](WORKSPACE-ARCHIVE.md): archive; [P6d](SAVED-VIEWS.md): 31 saved-view checks, 426 total regression + 9 operator-helper checks, restored-copy migration and isolated canary | P6 complete; P7 comments, mentions and notification preferences remain; views are private and explicitly refreshed, not live shared collaboration |
