...
| D / P4 | Bounded pagination and server-side search/filter/sort, quotas, complete export, conflict UX and measured load | [D1](TASK-PAGINATION.md): 2,106 rows; [D2a](TASK-VERSIONS.md): conditional writes; [D2b](TASK-SEARCH.md): global server finder, 284 checks | D1/D2a/D2b complete; full-view loading replacement, storage quotas and concurrent load remain |
