...
| E / P6-P7 | Member directory/assignment picker, workspace rename/archive/owner transfer, scoped comments and mentions | [P6a](TEAM-COLLABORATION.md): directory/assignment/rename; [P6b](WORKSPACE-OWNERSHIP.md): ownership; [P6c](WORKSPACE-ARCHIVE.md): 23 archive checks, 393 total regression + 9 operator-helper checks, restored-copy migration and isolated canary | P6a/P6b/P6c complete; saved-view sync, comments and mentions remain; archive does not override account-deletion/access-management rules |
