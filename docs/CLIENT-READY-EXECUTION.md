...
| D / P4 | Bounded pagination and server-side search/filter/sort, quotas, complete export, conflict UX and measured load | [D1](TASK-PAGINATION.md): 2,106 rows; [D2a](TASK-VERSIONS.md): conditional writes and two-tab draft recovery, 263 checks | D1 and D2a complete; server-side filters/sort, storage quotas and concurrent load still planned |
