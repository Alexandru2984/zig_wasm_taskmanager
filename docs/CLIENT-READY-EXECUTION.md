...
| E / P6-P7 | Member directory/assignment picker, workspace rename/archive/owner transfer, scoped comments and mentions | [P6a](TEAM-COLLABORATION.md): directory/assignment/rename; [P6b](WORKSPACE-OWNERSHIP.md): 25 ownership API/browser checks, 366 total regression + 9 operator-helper checks and isolated canary | P6a/P6b complete; archive, comments and mentions remain; transfer does not change task authorship/deletion policy |
