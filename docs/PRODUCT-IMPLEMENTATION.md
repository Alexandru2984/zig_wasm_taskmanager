...
| P1 | Atomic password changes/session revocation, account deletion and invite consumption; transaction-bound authorization for role/member/task mutations | Rollback, parallel request, stale-password, owner preservation and revoked-access regressions against SurrealDB 3.2.4 | In progress |
