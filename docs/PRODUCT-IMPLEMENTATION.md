...
| P4 | Pagination, server-side search/filter/sort, resource quotas and load measurements | [D1 pagination](TASK-PAGINATION.md); [D2a versions](TASK-VERSIONS.md); [D2b global finder](TASK-SEARCH.md): filtered/sorted server pages, 284 checks | D1/D2a/D2b complete; full-view loading replacement, storage quotas and concurrent capacity work remain |
