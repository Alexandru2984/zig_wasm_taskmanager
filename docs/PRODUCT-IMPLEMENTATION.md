...
| P4 | Pagination, server-side search/filter/sort, resource quotas and load measurements | [D1 pagination](TASK-PAGINATION.md); [D2a versions](TASK-VERSIONS.md); [D2b finder](TASK-SEARCH.md); [D2c quotas/usage/mixed load](TASK-QUOTAS.md): 303 regression + 9 operator-helper checks | D1/D2a/D2b/D2c complete; full-view loading replacement, physical/global storage control and broader capacity profiling remain |
