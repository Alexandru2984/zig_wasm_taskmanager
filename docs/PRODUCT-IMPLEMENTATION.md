...
| P1 | Atomic password changes/session revocation, account deletion and invite consumption; transaction-bound authorization for role/member/task mutations | [181 passing checks and limitations](PRODUCT-P1-VERIFICATION.md), including real DB rollback/concurrency cases | Complete; production promotion recorded separately |
