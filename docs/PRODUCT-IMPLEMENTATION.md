...
| P6 | Team lifecycle: minimal member directory, assignment picker, rename/archive workspace, owner transfer and per-workspace saved-view sync | [P6a directory/assignment/rename](TEAM-COLLABORATION.md); [P6b controlled ownership](WORKSPACE-OWNERSHIP.md); [P6c archive](WORKSPACE-ARCHIVE.md): 393 regression + 9 operator-helper checks, restored-copy migration and restricted canary | P6a/P6b/P6c complete; saved-view sync remains; archive preserves existing account-deletion/access-management exceptions |
