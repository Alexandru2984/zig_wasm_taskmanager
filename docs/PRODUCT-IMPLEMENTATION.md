...
| P6 | Team lifecycle: minimal member directory, assignment picker, rename/archive workspace, owner transfer and per-workspace saved-view sync | [P6a directory/assignment/rename](TEAM-COLLABORATION.md); [P6b controlled ownership](WORKSPACE-OWNERSHIP.md): 366 regression + 9 operator-helper checks | P6a/P6b complete; archive and saved-view sync remain; task authorship/deletion policy unchanged |
